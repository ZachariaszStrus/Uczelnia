...
public class MainWindowController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        this.destinationDirectoryLabel.textProperty().bind(destinationDirectory);
        ...
        this.destinationDirectory.set("F:\\Downloads\\grayscale");
    }    
    ...
    @FXML
    private void chooseDestinationDirectory(ActionEvent event) {
        DirectoryChooser directoryChooser = new DirectoryChooser();
        String choosenDirectory = directoryChooser.showDialog(null).getPath();
        this.destinationDirectory.set(choosenDirectory);
    }
    ...
    @FXML
    private void startConversionParallelDefault(ActionEvent event) {
        new Thread(() -> this.parallelConversion()).start();
    }
